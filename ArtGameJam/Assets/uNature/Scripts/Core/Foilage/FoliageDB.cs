...
namespace uNature.Core.FoliageClasses
{
    ...
    public sealed class FoliageDB : ScriptableObject
    {
        ...
        #region Variables
        [SerializeField]
        List<FoliagePrototype> _prototypes = new List<FoliagePrototype>();
        ...
        /// <summary>
        /// Hold the last assigned id to not create duplications in the future and make an completely unique id.
        /// </summary>
        [SerializeField]
        ...
        /// Add a new Foliage prototype.
        /// </summary>
        public void AddPrototype(DetailPrototype detailPrototype)
        {
            AddPrototype(detailPrototype.prototypeTexture, detailPrototype.prototype, detailPrototype.minWidth, detailPrototype.minHeight, detailPrototype.maxWidth, detailPrototype.maxHeight, detailPrototype.noiseSpread * 10, 0, detailPrototype.healthyColor, detailPrototype.dryColor);
        }

        /// <summary>
        /// Add a new Foliage prototype.
        /// </summary>
        public void AddPrototype(Texture2D texture)
        {
            AddPrototype(texture, null, 1.5f, 1f, 2f, 1.2f, 1f, 0, FoliagePrototype.DEFAULT_HEALTHY_COLOR, FoliagePrototype.DEFAULT_DRY_COLOR);
        }

        /// <summary>
        /// Add a new Foliage prototype.
        /// </summary>
        public void AddPrototype(GameObject prefab)
        {
            AddPrototype(null, prefab, 1.5f, 1f, 2f, 1.2f, 1f, prefab == null ? 0 : prefab.layer, FoliagePrototype.DEFAULT_HEALTHY_COLOR, FoliagePrototype.DEFAULT_DRY_COLOR);
        }
